...
Every tagged release ships [SLSA](https://slsa.dev) build provenance —
...
the [GitHub CLI](https://cli.github.com) (`gh attestation verify` — no extra
...
To pin to the exact image you run, resolve the digest yourself and verify (and
pull) by digest:
...
See [docs/SLSA.md](docs/SLSA.md) for the full supply-chain posture.
