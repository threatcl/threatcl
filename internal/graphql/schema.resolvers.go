...
type (
	additionalAttributeResolver  struct{ *Resolver }
	dataFlowDiagramResolver      struct{ *Resolver }
	informationAssetResolver     struct{ *Resolver }
	queryResolver                struct{ *Resolver }
	thirdPartyDependencyResolver struct{ *Resolver }
	threatResolver               struct{ *Resolver }
)
